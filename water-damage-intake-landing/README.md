# Water Damage Lead Intake Landing Page

One-page landing site for an AI Phone Intake & Lead Generation service built on Vapi + n8n. Designed for water damage restoration companies. Fast load, high conversion, easy deployment on GitHub Pages.
...
1. Push the `water-damage-intake-landing/` folder to a GitHub repository.
2. In GitHub, go to **Settings → Pages**.
3. Under **Build and deployment**, select:
   - Source: Deploy from a branch
   - Branch: `main` (or `master`), folder `/water-damage-intake-landing`
...
Then visit `http://localhost:8000/water-damage-intake-landing/` or the URL shown by your server.
